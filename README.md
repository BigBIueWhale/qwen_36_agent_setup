...
- **MTP (Multi-Token Prediction) head**: Qwen ships a 1-layer MTP module inside the main BF16 checkpoint (`mtp.*` tensors, 19 keys). Usable in vLLM for speculative decoding in principle. **We disable it** — see `#decision-mtp-disabled`.
